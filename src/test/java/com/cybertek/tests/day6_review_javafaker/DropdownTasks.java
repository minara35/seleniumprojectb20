package com.cybertek.tests.day6_review_javafaker;
...
//    }
    ...
    public void test4_multiple_value_select_dropdown() throws InterruptedException {
        ...
        //Creating a list if web elements ti store all if the options inside of this dropdown
        ...
        for(WebElement eachOption : allOptions){
            ...
            // Asserting option is selected or not
            Assert.assertTrue(eachOption.isSelected(), "The option:  " + eachOption.getText() + " is selected");
        }
